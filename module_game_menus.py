...
game_menus = [
  ...
  ("camp_companion", 0,
    ...
    [
      ("camp_comp_recruit",
      [],
      "Recruit_player_companions.",
      [
        (party_add_members, "p_main_party", "trp_npc_ironside", 1),
        (party_add_members, "p_main_party", "trp_npc_tsyolin", 1),
        (party_add_members, "p_main_party", "trp_npc_recent", 1),
        (party_add_members, "p_main_party", "trp_npc_dedmond", 1),
        (party_add_members, "p_main_party", "trp_npc_savage", 1),
        (party_add_members, "p_main_party", "trp_npc_luthien", 1),
        (party_add_members, "p_main_party", "trp_npc_poheniks", 1),
        (party_add_members, "p_main_party", "trp_npc_zeol", 1),
        (party_add_members, "p_main_party", "trp_npc_ymira", 1),
        (party_add_members, "p_main_party", "trp_npc_steel", 1),
        (party_add_members, "p_main_party", "trp_npc_tetsu", 1),
        (party_add_members, "p_main_party", "trp_npc_hessie", 1),
        (party_add_members, "p_main_party", "trp_npc_kyo", 1),
        ...
        (try_end),
        (display_message, "@Player companions recruited"),
      ]
      ),
