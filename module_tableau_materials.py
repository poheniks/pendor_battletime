...
tableaus = [
  ...
  [
    (store_script_param, ":var0", 1),
    (cur_tableau_set_background_color, 0x888888),
    (cur_tableau_set_ambient_light, 10, 11, 15),
  ...
  [
    (store_script_param, ":var0", 1),
    (set_fixed_point_multiplier, 100),
    (cur_tableau_set_background_color, 0x000000),
    ...
    (else_try),
      ...
      (cur_tableau_add_override_item, "itm_hide_boots"),
      (assign, ":var2", "anim_pose_fists_up"),
    (else_try),
      (eq, ":var0", 12),
    ...
    (else_try),
      ...
      (assign, ":var2", "anim_pose_fail"),
    (else_try),
      (eq, ":var0", 21),
      (cur_tableau_add_override_item, "itm_woolen_dress"),
      (assign, ":var2", "anim_pose_scratchass"),
    (else_try),
      (eq, ":var0", 22),
    ...
    (try_begin),
      ...
      (cur_tableau_add_troop, ":var8", pos2, "anim_pose_4", 0),
    (else_try),
  ...
  [
    ...
    (try_begin),
      (gt, ":var0", 0),
      (cur_tableau_add_horse, ":var0", pos1, "anim_horse_stand", 0),
    ...
    (try_for_range, ":var2", 1, ":var1"),
      ...
      (try_begin),
        (gt, ":var0", 0),
        (cur_tableau_add_horse, ":var0", pos2, "anim_horse_stand", 0),
        (cur_tableau_add_troop, ":var3", pos2, "anim_ride_0", ":var4"),
      (else_try),
        (cur_tableau_add_troop, ":var3", pos2, "anim_stand_man", ":var4"),
      (end_try),
    (end_try),
    (init_position, pos6),
