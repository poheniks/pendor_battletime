...
skills = [
  ...
  ("prisoner_management", "Prisoner Management", sf_base_att_cha, 10, "Every level of this skill increases the maximum number of prisoners by 10 and reduces the chance of a lord escaping after battle by 5%%. (Leader skill)"),
  ...
  ("tracking", "Tracking and Hunting", sf_base_att_int|sf_effects_party, 10, "Tracks become more informative. Each 3 points reduce food consumption by 15%%. (Party skill)"),
