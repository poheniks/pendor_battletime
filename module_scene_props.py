...
scene_props = [
  ...
  ("garlic", 0, "necturus_veggi_garlic", "0", []),

  ("garlic_b", 0, "necturus_veggi_garlic", "0", []),
  ...
  ("tunnel_salt", 0, "tunnel_salt_pop", "bo_tunnel_salt", []),
  ...
  ("castle_f_door_a", sokf_moveable, "castle_f_door_a", "bo_castle_f_door_a", []),
  ...
  ("banner_a", 0, "banner_kingdom_a", "0", []),

  ("banner_b", 0, "banner_kingdom_b", "0", []),

  ("banner_c", 0, "banner_kingdom_d", "0", []),
  ...
  ("banner_da", 0, "banner_kingdom_c", "0", []),
  ...
  ("banner_kingdom_b", 0, "banner_a02", "0", []),

  ("banner_kingdom_c", 0, "banner_d01", "0", []),

  ("banner_kingdom_d", 0, "banner_a03", "0", []),

  ("banner_kingdom_e", 0, "banner_a15", "0", []),
  ...
  ("tavern_chair_b", 0, "necturus_bs_stool", "bo_tavern_chair_b", []),
  ...
  ("gate_house_b", 0, "gate_house_b_mod", "bo_gate_house_b_mod", []),
  ...
  ("siege_ladder_move_10m", spr_use_time(3)|sokf_type_ladder|sokf_moveable, "siege_ladder_move_10m", "bo_siege_ladder_move_10m", [
    (ti_on_scene_prop_use,[
      (store_trigger_param_1, ":var0"),
      (store_trigger_param_2, ":var1"),
      (call_script, "script_use_item", ":var1", ":var0"),
  ...
  ("siege_ladder_move_12m", spr_use_time(3)|sokf_type_ladder|sokf_moveable, "siege_ladder_move_12m", "bo_siege_ladder_move_12m", [
    (ti_on_scene_prop_use,[
      (store_trigger_param_1, ":var0"),
      (store_trigger_param_2, ":var1"),
      (call_script, "script_use_item", ":var1", ":var0"),
  ...
  ("cauldron_a", 0, "cauldron_a_new", "bo_cauldron_a_new", []),
  ...
  ("lettuce", 0, "necturus_veggi_lettuce", "0", []),
  ...
  ("grape_a", 0, "necturus_veggi_grapes", "0", []),

  ("grape_b", 0, "necturus_veggi_grapes", "0", []),

  ("apple_a", 0, "necturus_veggi_apple_red", "0", []),

  ("apple_b", 0, "necturus_veggi_apple_green", "0", []),

  ("maize_a", 0, "maize_a", "0", []),

  ("maize_b", 0, "maize_b", "0", []),

  ("cabbage", 0, "necturus_veggi_cabbage", "0", []),
  ...
  ("cabbage_b", 0, "necturus_veggi_cabbage_b", "0", []),
  ...
  ("chicken_roasted", 0, "chicken_roasted_new", "0", []),
  ...
  ("earth_sally_gate_left", sokf_moveable, "earth_sally_gate_left", "bo_earth_sally_gate_left", []),

  ("earth_sally_gate_right", sokf_moveable, "earth_sally_gate_right", "bo_earth_sally_gate_right", []),
  ...
  ("moving_ship", 0, "moving_ship", "0", []),

  ("moving_ship_d", 0, "moving_ship_d", "0", []),

  ("S_yurt_base_blue_white", 0, "S_yurt_base_blue_white", "bo_S_yurt_base", []),

  ("S_object_amphora_a", 0, "S_object_amphora_a", "0", []),

  ("S_object_amphora_b", 0, "S_object_amphora_b", "0", []),

  ("S_object_carpet_a", 0, "S_object_carpet_a", "0", []),

  ("S_object_carpet_b", 0, "S_object_carpet_b", "0", []),

  ("S_yurt_base_red_white", 0, "S_yurt_base_red_white", "bo_S_yurt_base", []),

  ("S_yurt_base_white_red", 0, "S_yurt_base_white_red", "bo_S_yurt_base", []),

  ("S_yurt_base_white_blue", 0, "S_yurt_base_white_blue", "bo_S_yurt_base", []),

  ("S_yurt_command", 0, "S_yurt_command", "bo_S_yurt_command", []),

  ("S_yurt_kazakh", 0, "S_yurt_kazakh", "bo_S_yurt_kazakh", []),

  ("S_yurt_poor", 0, "S_yurt_poor", "bo_S_yurt_poor", []),

  ("S_yurt_simple", 0, "S_yurt_simple", "bo_S_yurt_simple", []),

  ("gondor_castle_h_battlement_a", 0, "gondor_castle_h_battlement_a", "bo_castle_h_battlement_a_tld", []),

  ("gondor_castle_h_battlement_b", 0, "gondor_castle_h_battlement_b", "bo_castle_h_battlement_b", []),

  ("gondor_castle_h_battlement_a2", 0, "gondor_castle_h_battlement_a2", "bo_castle_h_battlement_a_tld", []),

  ("gondor_castle_h_battlement_b2", 0, "gondor_castle_h_battlement_b2", "bo_castle_h_battlement_b2", []),

  ("gondor_castle_h_corner_a", 0, "gondor_castle_h_corner_a", "bo_castle_h_corner_a", []),

  ("gondor_castle_h_stairs_a", 0, "gondor_castle_h_stairs_a", "bo_castle_h_stairs_a_tld", []),

  ("gondor_castle_h_stairs_b", 0, "gondor_castle_h_stairs_b", "bo_castle_h_stairs_b", []),

  ("gondor_castle_h_gatehouse_a", 0, "gondor_castle_h_gatehouse_a", "bo_castle_h_gatehouse_a_tld", []),

  ("gondor_castle_h_keep_a", 0, "gondor_castle_h_keep_a", "bo_castle_h_keep_a", []),

  ("gondor_castle_h_keep_b", 0, "gondor_castle_h_keep_b", "bo_castle_h_keep_b", []),

  ("gondor_castle_h_house_a", 0, "gondor_castle_h_house_a", "bo_castle_h_house_a", []),

  ("gondor_castle_h_house_b", 0, "gondor_castle_h_house_b", "bo_castle_h_house_b", []),

  ("gondor_castle_h_house_c", 0, "gondor_castle_h_house_c", "bo_castle_h_house_b", []),

  ("gondor_castle_h_battlement_barrier", 0, "gondor_castle_h_battlement_barrier", "bo_castle_h_battlement_barrier", []),

  ("gondor_small_wall_d", 0, "gondor_small_wall_d", "bo_small_wall_d", []),

  ("gondor_small_wall_e", 0, "gondor_small_wall_e", "bo_small_wall_d", []),

  ("gondor_upper_apt", 0, "gondor_upper_apt_a", "0", []),

  ("cbstle_h_battlement_a", 0, "gondor_castle_h_battlement_a", "bo_castle_h_battlement_a_tld", []),

  ("cbstle_h_battlement_b", 0, "gondor_castle_h_battlement_b", "bo_castle_h_battlement_b", []),

  ("cbstle_h_battlement_a2", 0, "gondor_castle_h_battlement_a2", "bo_castle_h_battlement_a_tld", []),

  ("cbstle_h_battlement_b2", 0, "gondor_castle_h_battlement_b2", "bo_castle_h_battlement_b2", []),

  ("cbstle_h_corner_a", 0, "gondor_castle_h_corner_a", "bo_castle_h_corner_a", []),

  ("cbstle_h_stairs_a", 0, "gondor_castle_h_stairs_a", "bo_castle_h_stairs_a_tld", []),

  ("cbstle_h_stairs_b", 0, "gondor_castle_h_stairs_b", "bo_castle_h_stairs_b", []),

  ("cbstle_h_gatehouse_a", 0, "gondor_castle_h_gatehouse_a", "bo_castle_h_gatehouse_a_tld", []),

  ("cbstle_h_keep_a", 0, "gondor_castle_h_keep_a", "bo_castle_h_keep_a", []),

  ("cbstle_h_keep_b", 0, "gondor_castle_h_keep_b", "bo_castle_h_keep_b", []),

  ("cbstle_h_house_a", 0, "gondor_castle_h_house_a", "bo_castle_h_house_a", []),

  ("cbstle_h_house_b", 0, "gondor_castle_h_house_b", "bo_castle_h_house_b", []),

  ("cbstle_h_house_c", 0, "gondor_castle_h_house_c", "bo_castle_h_house_b", []),

  ("cbstle_h_battlement_barrier", 0, "gondor_castle_h_battlement_barrier", "bo_castle_h_battlement_barrier", []),

  ("slall_wall_d", 0, "gondor_small_wall_d", "bo_small_wall_d", []),

  ("slall_wall_e", 0, "gondor_small_wall_e", "bo_small_wall_d", []),
  ...
  ("gondor_statue_fem", 0, "gondor_statue_female_marble", "bo_gondor_statue_female_marble", []),

  ("gondor_statue_warrior", 0, "gondor_statue_warrior_marble", "bo_gondor_statue_ruined_warrior", []),

  ("gondor_altar", 0, "gondor_statue_altar", "bo_altar", []),

  ("gondor_statue_socle", 0, "gondor_statue_socle", "bo_statue_gondor", []),

  ("gondor_statue_king_a", 0, "gondor_statue_1", "bo_statue_gondor", []),

  ("gondor_statue_king_b", 0, "gondor_statue_2", "bo_statue_gondor", []),

  ("gondor_statue_king_c", 0, "gondor_statue_king1", "bo_gondor_king", []),

  ("gondor_statue_king_d", 0, "gondor_statue_king2", "bo_gondor_king", []),

  ("gondor_statue_king_e", 0, "gondor_statue_king3", "bo_gondor_king", []),

  ("gondor_arabian_castle_battlement_a", 0, "gondor_arabian_castle_battlement_a", "bo_arabian_castle_battlement_a", []),

  ("gondor_arabian_castle_battlement_b_destroyed", 0, "gondor_arabian_castle_battlement_b_destroyed", "bo_arabian_castle_battlement_b_destroyed", []),

  ("gondor_arabian_castle_battlement_c", 0, "gondor_arabian_castle_battlement_c", "bo_arabian_castle_battlement_c", []),

  ("gondor_arabian_castle_battlement_d", 0, "gondor_arabian_castle_battlement_d", "bo_arabian_castle_battlement_d", []),

  ("gondor_arabian_castle_corner_a", 0, "gondor_arabian_castle_corner_a", "bo_arabian_castle_corner_a", []),

  ("gondor_arabian_castle_stairs", sokf_type_ladder, "gondor_arabian_castle_stairs", "bo_arabian_castle_stairs", []),

  ("gondor_arabian_castle_stairs_c", sokf_type_ladder, "gondor_arabian_castle_stairs_c", "bo_arabian_castle_stairs_c", []),

  ("gondor_arabian_castle_battlement_section_a", 0, "gondor_arabian_castle_battlement_section_a", "bo_arabian_castle_battlement_section_a", []),

  ("gondor_arabian_castle_gate_house_a", 0, "gondor_arabian_castle_gate_house_a", "bo_arabian_castle_gate_house_a", []),

  ("gondor_arabian_castle_house_a", 0, "gondor_arabian_castle_house_a", "bo_arabian_castle_house_a", []),

  ("gondor_arabian_castle_house_b", 0, "gondor_arabian_castle_house_b", "bo_arabian_castle_house_b", []),

  ("gondor_arabian_castle_keep_a", 0, "gondor_arabian_castle_keep_a", "bo_arabian_castle_keep_a", []),

  ("gondor_arabian_castle_corner_b", 0, "gondor_arabian_castle_corner_b", "bo_arabian_castle_corner_b", []),

  ("gondor_castle_e_tower", 0, "gondor_castle_e_tower", "bo_castle_e_tower", []),

  ("gondor_castle_f_tower_a", sokf_type_ladder, "gondor_castle_f_tower_a", "bo_castle_f_tower_a", []),

  ("gondor_castle_f_sally_port_elevation", 0, "gondor_castle_f_sally_port_elevation", "bo_castle_f_sally_port_elevation", []),

  ("gondor_castle_h_corner_c", 0, "gondor_castle_h_corner_c", "bo_castle_h_corner_c", []),

  ("gondor_castle_h_battlement_c", 0, "gondor_castle_h_battlement_c", "bo_castle_h_battlement_c", []),

  ("gondor_tower_minaret_a", 0, "gondor_stone_minaret_a", "bo_stone_minaret_a", []),

  ("gondor_fake_house_far_a", 0, "gondor_fake_house_far_a", "0", []),

  ("gondor_fake_house_far_b", 0, "gondor_fake_house_far_b", "0", []),

  ("gondor_fake_house_far_c", 0, "gondor_fake_house_far_c", "0", []),

  ("gondor_fake_house_far_d", 0, "gondor_fake_house_far_d", "0", []),

  ("gondor_timber_frame_extension_a", 0, "gondor_timber_frame_extension_a", "bo_timber_frame_extension_a", []),

  ("gondor_timber_frame_extension_b", 0, "gondor_timber_frame_extension_b", "bo_timber_frame_extension_b", []),

  ("gondor_side_building_a", 0, "gondor_side_building_a", "bo_side_building_a", []),

  ("gondor_house_extension_a", 0, "gondor_house_extension_a", "bo_house_extension_a", []),

  ("gondor_house_extension_b", 0, "gondor_house_extension_b", "bo_house_extension_b", []),

  ("gondor_house_extension_c", 0, "gondor_house_extension_c", "bo_house_extension_a", []),

  ("gondor_house_extension_d", 0, "gondor_house_extension_d", "bo_house_extension_d", []),

  ("gondor_stairs_arch_a", sokf_type_ladder, "gondor_stairs_arch_a", "bo_stairs_arch_a", []),

  ("gondor_door_extension_a", 0, "gondor_door_extension_a", "bo_door_extension_a", []),

  ("gondor_bridge_modular_a", 0, "gondor_bridge_modular_a", "bo_bridge_modular_a", []),

  ("gondor_bridge_modular_b", 0, "gondor_bridge_modular_b", "bo_bridge_modular_b", []),

  ("gondor_house_extension_f", 0, "gondor_house_extension_f", "bo_house_extension_f", []),

  ("gondor_house_extension_f2", 0, "gondor_house_extension_f2", "bo_house_extension_f", []),

  ("gondor_house_extension_g", 0, "gondor_house_extension_g", "bo_house_extension_g", []),

  ("gondor_house_extension_g2", 0, "gondor_house_extension_g2", "bo_house_extension_g", []),

  ("gondor_house_extension_h", 0, "gondor_house_extension_h", "bo_house_extension_h", []),

  ("gondor_passage_house_d", 0, "gondor_passage_house_d", "bo_passage_house_d", []),

  ("gondor_small_wall_b", 0, "gondor_small_wall_b", "bo_small_wall_b", []),

  ("gondor_small_wall_c", 0, "gondor_small_wall_c", "bo_small_wall_c", []),

  ("gondor_small_wall_c_destroy", 0, "gondor_small_wall_c_destroy", "bo_small_wall_c_destroy", []),

  ("gondor_stone_step_b", 0, "gondor_stone_step_b", "0", []),

  ("gondor_stone_step_c", 0, "gondor_stone_step_c", "0", []),

  ("gondor_stone_heap", 0, "gondor_stone_heap", "bo_stone_heap", []),

  ("gondor_stone_heap_b", 0, "gondor_stone_heap_b", "bo_stone_heap", []),

  ("apple_basket", 0, "apple_basket", "bo_apple_basket", []),

  ("bread_c", 0, "necturus_food_bread_white", "0", []),

  ("bread_d", 0, "necturus_food_bread_white_cut", "0", []),

  ("bread_e", 0, "necturus_food_cakes_many", "0", []),

  ("honey", 0, "necturus_food_honey", "0", []),

  ("sausage_salami", 0, "necturus_food_sang_cut_plate", "0", []),

  ("sausage_several", 0, "necturus_food_sausage_many_plate", "0", []),

  ("eggs_on_plate", 0, "necturus_food_egg_many_plate", "0", []),

  ("carpet_acok_1", 0, "carpet_acok_1", "0", []),

  ("carpet_acok_2", 0, "carpet_acok_2", "0", []),

  ("carpet_acok_3", 0, "carpet_acok_3", "0", []),

  ("carpet_acok_4", 0, "carpet_acok_4", "0", []),

  ("carpet_acok_5", 0, "carpet_acok_5", "0", []),

  ("carpet_acok_rushes_1", 0, "carpet_acok_rushes_1", "0", []),

  ("carpet_acok_rushes_2", 0, "carpet_acok_rushes_2", "0", []),

  ("globe_witcher", 0, "witcher_globe", "bo_witcher_globe", []),

  ("cauldron_old", 0, "cauldron_a", "bo_cauldron_a", []),

  ("cauldron_2", 0, "witcher_cauldron_2", "bo_witcher_cauldron_2", []),

  ("statue_wines", 0, "statue_wines", "bo_statue_wines", []),

  ("scroll_1", 0, "necturus_scroll_1", "0", []),

  ("scroll_2", 0, "necturus_scroll_2", "0", []),

  ("scroll_3", 0, "necturus_scroll_3", "0", []),

  ("painting_on_wall_1", 0, "painting_on_wall_1", "0", []),

  ("painting_on_wall_2", 0, "painting_on_wall_2", "0", []),

  ("painting_on_wall_3", 0, "painting_on_wall_3", "0", []),

  ("painting_on_wall_4", 0, "painting_on_wall_4", "0", []),

  ("painting_on_wall_5", 0, "painting_on_wall_5", "0", []),

  ("painting_on_wall_6", 0, "painting_on_wall_6", "0", []),

  ("painting_on_wall_7", 0, "painting_on_wall_7", "0", []),

  ("painting_on_wall_8", 0, "painting_on_wall_8", "0", []),

  ("painting_on_wall_9", 0, "painting_on_wall_9", "0", []),

  ("chair_acok_1", 0, "necturus_banket_chair", "bo_necturus_banket_chair", []),

  ("chair_acok_2", 0, "necturus_throne", "bo_necturus_banket_chair", []),

  ("chair_acok_3", 0, "necturus_common_chair", "bo_necturus_common_chair", []),

  ("table_long_acok_1", 0, "necturus_banket_table", "bo_necturus_banket_table", []),

  ("carpet_acok_11", 0, "necturus_carpet_1", "0", []),

  ("carpet_acok_6", 0, "necturus_carpet_2", "0", []),

  ("carpet_acok_7", 0, "necturus_carpet_3", "0", []),

  ("carpet_acok_8", 0, "necturus_carpet_4", "0", []),

  ("carpet_acok_9", 0, "necturus_carpet_5", "0", []),

  ("carpet_acok_10", 0, "necturus_carpet_6", "0", []),

  ("fruit_apple_half", 0, "necturus_veggi_apple_green_half", "0", []),

  ("fruit_apple_yellow", 0, "necturus_veggi_apple_yellow", "0", []),

  ("fruit_lemon", 0, "necturus_veggi_lemon", "0", []),

  ("fruit_lemon_half", 0, "necturus_veggi_lemon_half", "0", []),

  ("fruit_peach", 0, "necturus_veggi_peach", "0", []),

  ("fruit_peach_red", 0, "necturus_veggi_pear_red", "0", []),

  ("fruit_peach_half", 0, "necturus_veggi_peach_half", "0", []),

  ("fruit_pear", 0, "necturus_veggi_pear_green", "0", []),

  ("fruit_pear_half", 0, "necturus_veggi_pear_green_half", "0", []),

  ("vegetable_beet", 0, "necturus_veggi_beet", "0", []),

  ("vegetable_beet_part", 0, "necturus_veggi_beet_piece", "0", []),

  ("vegetable_carrot", 0, "necturus_veggi_carrot", "0", []),

  ("vegetable_carrot_pieces", 0, "necturus_veggi_carrot_piece", "0", []),

  ("vegetable_garlic_one", 0, "necturus_veggi_garlic_single", "0", []),

  ("vegetable_onion_piece", 0, "necturus_veggi_onion_piece", "0", []),

  ("vegetable_onion", 0, "necturus_veggi_onions", "0", []),

  ("vegetable_pumpkin", 0, "necturus_veggi_pumpkin", "0", []),

  ("door_castle_e", 0, "castle_e_sally_door_a", "0", []),

  ("wall_snouz", 0, "wall_snouz", "bo_wall_snouz", []),

  ("lamp_oil_acok", 0, "necturus_oil_lamp_2", "0", [
    (ti_on_scene_prop_init,[
      (set_position_delta, 0, -21, -43),
      (particle_system_add_new, "psys_candle_light"),
    ]),
  ]),

  ("torch_acok", 0, "necturus_torch", "0", [
    (ti_on_scene_prop_init,[
      (set_position_delta, 0, -34, 27),
      (particle_system_add_new, "psys_torch_fire"),
      (particle_system_add_new, "psys_torch_smoke"),
      (particle_system_add_new, "psys_torch_fire_sparks"),
      (play_sound, "snd_torch_loop", 0),
      (set_position_delta, 0, -34, 33),
      (particle_system_add_new, "psys_fire_glow_1"),
      (get_trigger_object_position, pos2),
      (set_position_delta, 0, 0, 0),
      (position_move_y, pos2, -34),
      (position_move_z, pos2, 33),
      (particle_system_burst, "psys_fire_glow_fixed", pos2, 1),
    ]),
  ]),

  ("apple_basket_new", 0, "fruit_basket", "bo_apple_basket", []),

  ("bath_metal", 0, "necturus_bath", "bo_necturus_bath", []),

  ("candle_stick", 0, "necturus_candle_stick", "0", [
    (ti_on_scene_prop_init,[
      (set_position_delta, 0, 0, 110),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, 21, 0, 96),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, -21, 0, 96),
      (particle_system_add_new, "psys_candle_light"),
    ]),
  ...
  ("chandelier_classy", 0, "necturus_chandelier", "0", [
    (ti_on_scene_prop_init,[
      (set_position_delta, 131, 0, 53),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, -131, 0, 53),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, 0, 131, 53),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, 0, -131, 53),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, 115, 65, 53),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, -115, 65, 53),
      (particle_system_add_new, "psys_candle_light"),
      (set_position_delta, 115, -65, 53),
...
#COOP BEGIN############################################################################
  ("coop_inventory",spr_use_time(2),"package","bobaggage", [
   (ti_on_scene_prop_use,
    [
      ...
      (try_end),
      (try_begin),
        (eq, "$coop_inventory_box", ":instance_id"), #only call this for player team box
        (call_script, "script_coop_player_access_inventory",":player_agent"),
      (try_end),
    ]),
  ]),
#COOP END#########################################################################################
