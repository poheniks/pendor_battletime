...
#COOP BEGIN###################################################################################
multiplayer_event_coop_send_to_server                         = 113
multiplayer_event_coop_send_to_player                         = 114
multiplayer_event_coop_send_to_player_string                  = 115
# clients can only recieve up to multiplayer_event = 127
#COOP END#########################################################################################
...
#COOP BEGIN################################################################
multiplayer_game_type_coop_battle            = 8
multiplayer_game_type_coop_siege             = 9
